    ...
    @foreach ($lugares as $lugare)
        ...
        <div class="col-md-6 col-lg-4 mb-5">
            <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1{{ $lugare->id}}">
                ...
                <img class="img-fluid object-fit " src="{{ $lugare->imagen }}" alt="..." />
            </div>
        </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">{{ $lugare->nombre }} <br><a href="{{ $lugare->url }}">Visitar web</a></h2>
                                    <!-- Icon Divider-->
